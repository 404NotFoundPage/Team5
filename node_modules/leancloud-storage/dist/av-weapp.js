...
var CustomEventTarget = __webpack_require__(26);
var EventWrapper = __webpack_require__(27);
...
var _ = __webpack_require__(0);
var Promise = __webpack_require__(1);
var localStorage = __webpack_require__(40);
...
AV.localStorage = __webpack_require__(19);
...
var OnlineOfflineEvents = __webpack_require__(28);
...
var comments = ["Weapp" || 'Node.js'].concat(__webpack_require__(30));
...
var AV = __webpack_require__(5);
var AppRouter = __webpack_require__(43);
...
var _ = __webpack_require__(0);
var cos = __webpack_require__(50);
var qiniu = __webpack_require__(51);
var s3 = __webpack_require__(52);
...
var parseBase64 = __webpack_require__(56);
...
module.exports = function upload(uploadInfo, data, file) {
  ...
  return new Promise(function (resolve, reject) {
    var req = request('POST', uploadUrl).set(file._uploadHeaders).attach('file', data, file.attributes.name).field('name', file.attributes.name).field('key', file._qiniu_key).field('token', uptoken);
    if (saveOptions.onprogress) {
      req.on('progress', saveOptions.onprogress);
    }
    req.end(function (err, res) {
      ...
      AV._arrayEach(this._opSetQueue, function (opSet) {
        ...
        if (op) {
          var _findValue3 = findValue(self.attributes, key),
              _findValue4 = _slicedToArray(_findValue3, 3),
              value = _findValue4[0],
...
var mergeUnionDataIntoAuthData = function mergeUnionDataIntoAuthData(authData, unionId) {
  var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      ...
      asMainAccount = _ref2$asMainAccount === undefined ? false : _ref2$asMainAccount;
...
module.exports = function (AV) {
  ...
  /** @lends AV.User.prototype */{
     ...
     * });
     */
    associateWithAuthDataAndUnionId: function associateWithAuthDataAndUnionId(authData, platform, unionId, unionLoginOptions) {
    ...
    isAuthenticated: function isAuthenticated() {
      ...
      return Promise.resolve().then(function () {
        return !!_this3._sessionToken && AV.User._fetchUserBySessionToken(_this3._sessionToken).then(function () {
          return true;
        }, function (error) {
          if (error.code === 211) {
            return false;
    ...
    refreshSessionToken: function refreshSessionToken(options) {
      ...
      return AVRequest('users/' + this.id + '/refreshSessionToken', null, null, 'PUT', null, options).then(function (response) {
        _this4._finishFetch(response);
        return _this4._handleSaveResult(true).then(function () {
          return _this4;
        });
      });
    },
  ...
  /** @lends AV.User */{
     ...
     * });
     */
    signUpOrlogInWithAuthDataAndUnionId: function signUpOrlogInWithAuthDataAndUnionId(authData, platform, unionId, unionLoginOptions) {
    ...
    init: function init(query) {
      ...
      return Promise.resolve(userDefinedSubscriptionId).then(function (subscriptionId) {
        return AV._config.realtime.createLiveQueryClient(subscriptionId).then(function (liveQueryClient) {
          ...
          return subscribe(queryJSON, subscriptionId).then(function (_ref3) {
